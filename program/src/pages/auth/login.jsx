            ...
            <div className="bg-muted/60 relative hidden h-full flex-col border-r p-10 lg:flex">
                ...
                <div className="z-10 mt-auto">
                    <blockquote className="space-y-2">
                        <p className="text-xl">
                            &ldquo;PharmaCare transformed how we manage our pharmacy. Inventory tracking is now automated, prescription processing is seamless, and our team can focus on patient care instead of paperwork.&rdquo;
                        </p>
                ...
                <div className="mx-auto space-y-4 sm:w-sm">
                    ...
                    <div className="flex flex-col space-y-1">
                        ...
                        <p className="text-muted-foreground text-base">
                            Login to your PharmaCare account.
                        </p>
                    </div>
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                <label className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                                    Password <span className="text-muted-foreground text-xs">(Optional for testing)</span>
                                </label>
                                <a
                    ...
                    <div className="flex items-center justify-between text-sm">
                        <a href="/auth/forgot-password" className="text-muted-foreground hover:text-primary underline underline-offset-4">
                            Forgot Password?
                        </a>
                        <a href="/auth/signup" className="text-muted-foreground hover:text-primary underline underline-offset-4">
                            Create Account
                        </a>
                    </div>
