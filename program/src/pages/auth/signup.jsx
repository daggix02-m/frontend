                ...
                <div className="mx-auto space-y-4 sm:w-sm">
                    ...
                    <div className="flex flex-col space-y-1">
                        ...
                        <p className="text-muted-foreground text-base">
                            Step {step} of 3: {step === 1 ? 'Pharmacy Details' : step === 2 ? 'Manager Details' : 'Main Branch Details'}
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {step === 2 && (
                            ...
                            >
                                ...
                                {errors.managerEmail && <p className="text-red-500 text-xs">{errors.managerEmail}</p>}
                                ...
                                {errors.managerPassword && <p className="text-red-500 text-xs">{errors.managerPassword}</p>}
                                ...
                                {errors.managerPhone && <p className="text-red-500 text-xs">{errors.managerPhone}</p>}
                        ...
                        {step === 3 && (
                            ...
                            >
                                ...
                                {errors.branchContact && <p className="text-red-500 text-xs">{errors.branchContact}</p>}
                    ...
                    <div className="text-center text-sm">
                        ...
                        <a href="/auth/login" className="text-muted-foreground hover:text-primary underline underline-offset-4">
                            Sign In
                        </a>
                    </div>
                </div>
