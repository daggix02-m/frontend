            ...
            <CardContent>
                <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                        ...
                        {revenueChange !== undefined && (
                            <div className={`flex items-center gap-1 text-xs ${isPositiveChange ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
                                {isPositiveChange ? (
                ...
                <div className="mt-4 pt-4 border-t border-border">
                    <div className="flex items-center justify-between text-xs">
                        ...
                        <span className={`font-medium ${inventoryStatus === 'healthy' ? 'text-green-600 dark:text-green-400' :
                                inventoryStatus === 'warning' ? 'text-yellow-600 dark:text-yellow-400' :
