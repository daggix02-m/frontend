...
import { getBranches, createBranch } from '@/api/auth.api';
...
export function BranchManagement() {
    ...
    useEffect(() => {
        ...
        // fetchBranches();
        setBranches([
            { id: 1, name: 'Main Branch', address: '123 Main St, City', contact: '555-0101' },
            { id: 2, name: 'Downtown Branch', address: '456 Market St, City', contact: '555-0102' },
        ]);
    }, []);
