...
export function DashboardLayout({ role = 'manager' }) { // Default to manager for now, but should be passed or retrieved
                    ...
                    <div className="flex items-center gap-4 ml-auto">
                        <div className="flex items-center gap-2">
                            ...
                            <div className="hidden md:block">
                                <p className="text-sm font-medium text-gray-700 dark:text-gray-200 capitalize">{role}</p>
